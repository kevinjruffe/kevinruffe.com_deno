 ...
 */
declare module 'url' {
    import { Blob } from 'https://esm.sh/v102/@types/node@16.18.10/buffer.d.ts';
    import { ClientRequestArgs } from 'https://esm.sh/v102/@types/node@16.18.10/http.d.ts';
    import { ParsedUrlQuery, ParsedUrlQueryInput } from 'https://esm.sh/v102/@types/node@16.18.10/querystring.d.ts';
    // Input to `url.format`
    interface UrlObject {
...
declare module 'https://esm.sh/v102/@types/node@16.18.10/url.d.ts' {
    export * from 'url';
}

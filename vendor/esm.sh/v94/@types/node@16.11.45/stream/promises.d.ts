...
declare module 'stream/promises' {
    import { FinishedOptions, PipelineSource, PipelineTransform, PipelineDestination, PipelinePromise, PipelineOptions } from 'https://esm.sh/v94/@types/node@16.11.45/stream.d.ts';
...
declare module 'https://esm.sh/v94/@types/node@16.11.45/stream/promises.d.ts' {

 ...
 */
declare module 'url' {
    import { Blob } from 'https://esm.sh/v94/@types/node@16.11.45/buffer.d.ts';
    import { ClientRequestArgs } from 'https://esm.sh/v94/@types/node@16.11.45/http.d.ts';
    import { ParsedUrlQuery, ParsedUrlQueryInput } from 'https://esm.sh/v94/@types/node@16.11.45/querystring.d.ts';
    // Input to `url.format`
    interface UrlObject {
...
declare module 'https://esm.sh/v94/@types/node@16.11.45/url.d.ts' {
    export * from 'url';
}

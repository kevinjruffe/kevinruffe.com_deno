 ...
 */
declare module 'http' {
    import * as stream from 'https://esm.sh/v94/@types/node@16.11.45/stream.d.ts';
    import { URL } from 'https://esm.sh/v94/@types/node@16.11.45/url.d.ts';
    import { TcpSocketConnectOpts, Socket, Server as NetServer, LookupFunction } from 'https://esm.sh/v94/@types/node@16.11.45/net.d.ts';
...
declare module 'https://esm.sh/v94/@types/node@16.11.45/http.d.ts' {
    export * from 'http';
}

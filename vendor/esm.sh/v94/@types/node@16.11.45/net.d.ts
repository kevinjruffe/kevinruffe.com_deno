...
declare module 'net' {
    ...
    import { Abortable, EventEmitter } from 'https://esm.sh/v94/@types/node@16.11.45/events.d.ts';
    import * as dns from 'https://esm.sh/v94/@types/node@16.11.45/dns.d.ts';
...
declare module 'https://esm.sh/v94/@types/node@16.11.45/net.d.ts' {
    export * from 'net';
}
